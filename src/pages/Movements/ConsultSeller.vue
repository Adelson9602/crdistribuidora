    ...
    <q-card class="height-card_page q-pa-md">
      <q-card-section class="q-gutter-y-md">
                  ...
                  <q-item>
                    <q-item-section>
                      ...
                      <q-item-label class="number_card">{{
                        comision.percent_commission
                      }}</q-item-label>
                      <q-item-label>
                        <q-icon name="info" color="positive" /> Comisión
                      </q-item-label>
                    </q-item-section>
                    <q-item-section side>
                      <q-avatar
                ...
                <q-list>
                  <q-item>
                    <q-item-section>
                      ...
                      <q-item-label>
                        <q-icon name="info" color="positive" /> Alcanzado
                      </q-item-label>
                    </q-item-section>
                    <q-item-section side>
                      <q-avatar
        ...
        <div class="row height-table justify-center">
          ...
          <q-spinner-facebook color="primary" size="2em" v-if="!render_table" />
        </div>
      </q-card-section>
    </q-card>
  </q-page>
        ...
        update(
          () => {
            if (val === "") {
              ...
              this.options_seller = all_seller.filter(
                v =>
