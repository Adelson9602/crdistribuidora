  ...
  <q-page padding>
    <q-card class="height-card_page">
      ...
      >
        ...
        <q-tab
          name="transfer_cellar"
          label="Realizar Translados"
          icon="refresh"
        />
      </q-tabs>
                ...
                <q-card-section class="row">
                  ...
                  >
                    ...
                    <q-field
                      ...
                      dense
                      v-if="
                        encabezado_selecte.Etm_Estado == 0 &&
                          index != 'Estado' &&
                          index != 'Nombre quien recibe'
                      "
                    >
                      <template v-slot:control>
                        <div
                    ...
                    <q-select
                      ...
                      emit-value
                      v-if="
                        index == 'Estado' && encabezado_selecte.Etm_Estado == 0
                      "
                    />
                    <q-select
                      dense
      ...
      this.timer = setTimeout(async () => {
        ...
        if (this.encabezado_selecte.Etm_Estado == 0) {
          this.timer = setTimeout(
            this.getDataMovilDestino(this.encabezado_selecte.Etm_Mov_Id_recibe),
            1000
          );
        }
      }, 1000);
    ...
    updateTraslado() {
      ...
      this.timer = setTimeout(async () => {
        try {
          ...
          const res_enc = await this.insertEncTransfer(
            this.encabezado_selecte
          ).then(res => {
            return res.data;
          });
          console.log({
