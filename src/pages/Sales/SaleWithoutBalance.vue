    ...
    <q-card class="height-card_page q-pa-md">
      ...
      <q-tab-panels v-model="tab" animated>
        ...
        <q-tab-panel name="add_sales">
          <component-add-sale-without-balance />
        </q-tab-panel>
      </q-tab-panels>
    </q-card>
  </q-page>
...
<script>
import ComponentAddSaleWithoutBalance from 'components/Sales/ComponentAddSaleWithoutBalance';
import ComponentTable from 'components/Generals/ComponentTable';
export default {
  name: 'SaleswithoutBalance',
  components: {
    ComponentAddSaleWithoutBalance,
    ComponentTable
  },
  data(){
    return {
