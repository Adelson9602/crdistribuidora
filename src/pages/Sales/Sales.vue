                ...
                <div class="ticket">
                  ...
                  <div class="text-center">
                    <p class="q-ma-none">
                      ...
                      >{{
                        encabezado_selected
                          ? encabezado_selected.Ev_Fecha_venta
                          : ""
                      }}
                    </p>
                    <p class="q-ma-none">
                      ...
                      {{
                        encabezado_selected
                          ? encabezado_selected.CP_Razon_social
                          : ""
                      }}
                    </p>
                    <p class="q-ma-none">
                      <span class="text-bold">C.C:</span>
                      {{
                        encabezado_selected ? encabezado_selected.CP_Nit : ""
                      }}
                    </p>
                    <p class="q-ma-none">
                      <span class="text-bold">Remisión No: </span>
                      {{ encabezado_selected ? encabezado_selected.Ev_Id : "" }}
                    </p>
                    <p class="q-ma-none">
                      <span class="text-bold">Método Pago:</span>
                      {{
                        encabezado_selected ? encabezado_selected.name_mp : ""
                      }}
                    </p>
                  </div>
                  <table class="ticket_print">
                    ...
                    <tr
                      class="data"
                      v-for="(product, key) in product_saled"
                      :key="key"
                    >
                      ...
                      <td class="precio">
                        {{ new Intl.NumberFormat().format(product.valor) }}
                      </td>
                    </tr>
                  </table>
                      ...
                      <td>
                        ...
                        {{
                          new Intl.NumberFormat().format(
                            encabezado_selected
                              ? encabezado_selected.Ev_Subtotal
                              : 0
                          )
                        }}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        {{
                          new Intl.NumberFormat().format(
                            encabezado_selected
                              ? encabezado_selected.Ev_Des_total_art
                              : 0
                          )
                        }}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        {{
                          new Intl.NumberFormat().format(
                            encabezado_selected
                              ? encabezado_selected.Ev_Descuentog
                              : 0
                          )
                        }}
                      </td>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        {{
                          new Intl.NumberFormat().format(
                            encabezado_selected
                              ? encabezado_selected.Ev_Total_venta
                              : 0
                          )
                        }}
                      </td>
                  ...
                  <br />
                  <p class="text-center">
                    <span class="text-bold">N° Artículos </span
                    >{{
                      encabezado_selected ? encabezado_selected.cantidad_art : 0
                    }}
                  </p>
                  <p class="text-center">
                    <span class="text-bold">Vendedor </span
                    >{{
                      encabezado_selected ? encabezado_selected.Per_Nombre : 0
                    }}
                    <br />
                    ¡GRACIAS POR SU COMPRA!
                    <br />sigi.appears.com.co
                  </p>
                      ...
                      <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 q-px-sm">
                          <q-input
                            ...
                            :rules="[
                              val => !!val || 'Días de céedito es obligatorio'
                            ]"
                            v-if="
                              mp_id == 2 &&
    ...
    async getDataPrint(row) {
      ...
      try {
        ...
        if (res_deta.ok) {
          if (res_deta.result) {
            res_deta.data.forEach(product => {
              this.encabezado_selected.cantidad_art =
                Number(this.encabezado_selected.cantidad_art) +
                Number(product.Dv_Cant);
              this.product_saled.push({
                ...
                valor:
                  Number(product.Dv_Cant) * Number(product.Dv_precio_venta),
    ...
    aprovedCredit(row) {
      this.$q
        .dialog({
          ...
          msg:
            "Esta venta ha sido realizada como crédito, ¿Seguro que desea aprobarla?"
        })
        .onOk(() => {
          this.$q.loading.show({
